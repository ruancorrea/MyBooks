...
export default function Pagination(props: PaginationProps) {
    ...
    return (
        <div className="flex items-center space-x-1 my-4 justify-center ">
            {
                props.pageAtual > 1 ?
                <button onClick={() => props.AlterandoStartIndex(props.pageAtual-1)} className="dark:bg-gray-700 px-4 py-2 text-gray-500 bg-gray-200 rounded-md hover:bg-blue-400 hover:text-white">
                ...
                return(
                    <div key={index}>
                        { page === props.pageAtual ?
                            <button onClick={() => props.AlterandoStartIndex(page)} className="dark:bg-gray-700 px-4 py-2 text-gray-100 bg-gray-700 rounded-md hover:bg-blue-400 hover:text-white">
                                {page}
                            </button> 

                            :
                            <button onClick={() => props.AlterandoStartIndex(page)} className="dark:bg-gray-700 px-4 py-2 text-gray-500 bg-gray-200 rounded-md hover:bg-blue-400 hover:text-white">
                                {page}
                            </button>
